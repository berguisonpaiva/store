# mobile-core-infrastructure Specification

## Purpose

Provide generic technical infrastructure for the Flutter app in `lib/core/`: wrappers behind interfaces, an HTTP client configured for the backend, and a technical Exception hierarchy.
