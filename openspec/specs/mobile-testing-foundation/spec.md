# mobile-testing-foundation Specification

## Purpose

Establish the testing foundation for the Flutter app: a test harness with helpers and fakes, and passing example tests demonstrating the patterns per layer.
