...
Establish the base design system for the Flutter app in `lib/ui/`: a Material 3 theme with tokens and dark mode, shared widgets and feedback helpers, and localization infrastructure.
