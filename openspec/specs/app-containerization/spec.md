# app-containerization Specification

## Purpose

Define per-app Docker images for the frontend and backend and the Docker Compose wiring that runs them together for local development.
