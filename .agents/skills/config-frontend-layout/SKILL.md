...
node .Codex/skills/config-frontend-layout/scripts/apply.mjs --layout=simple
node .Codex/skills/config-frontend-layout/scripts/apply.mjs --layout=modules

# Ou informe o app de destino (web, frontend, ou outro nome em apps/)
node .Codex/skills/config-frontend-layout/scripts/apply.mjs --layout=modules --app=web
```
...
- **Assets embarcados são a fonte** — use sempre `.Codex/skills/config-frontend-layout/assets/`.
