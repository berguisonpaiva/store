...
/// Register a stock entry (motivo COMPRA/DEVOLUCAO/AJUSTE).
...
class _StockEntryPageState extends State<StockEntryPage> {
  ...
  StockMovementReason _reason = StockMovementReason.compra;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n.inventoryEntryTitle)),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: AppSpacing.md),
                  ReasonDropdown(
                    reasons: StockMovementReason.entryReasons,
                    value: _reason,
                    enabled: !state.isSubmitting,
                    onChanged: (r) => setState(
                      () => _reason = r ?? StockMovementReason.compra,
                    ),
                  ),
