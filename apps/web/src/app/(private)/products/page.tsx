...
/**
 * Products list (private). Server Component: parses the URL search params,
 * fetches the paginated list + categories with the session Bearer token, and
 * hands them to the client list (which owns the `nuqs` filter state).
 */
